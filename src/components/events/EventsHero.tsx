...
const EventsHero = () => {
  return (
    <section className="relative bg-gradient-to-r from-studynet-lightblue to-white pt-32 pb-16 md:pt-40 md:pb-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10 animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              StudyNet <span className="text-studynet-blue">Events</span>
            </h1>
